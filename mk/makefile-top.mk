...
lib.name = visu~
class.sources = src/wfvisu~.cc src/sgvisu~.cc src/ogvisu~.cc
common.sources = src/visu~.cc src/visu~-remote.cc src/util/self_path.cc
gui.sources = src/visu~-gui.cc src/gui/w_dft_waterfall.cc src/gui/w_dft_spectrogram.cc src/gui/w_ts_oscillogram.cc
